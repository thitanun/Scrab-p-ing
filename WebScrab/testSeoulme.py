...
class testSeoulme:
    ...
    def data_domain_for_ref(self, session, url):
        with session.get(url) as response:
            ...
            news_link = []
            list_link = []
            for div in bs.find_all('h2', {'class' : 'entry-title'}):
                a = div.find('a')
            ...
            self.webdata['website']['www.seoul2me.com'] = list_link


    def scrap_for_ref(self):
        pages_list = [f'https://www.seoul2me.com/category/%E0%B8%82%E0%B9%88%E0%B8%B2%E0%B8%A7%E0%B8%9A%E0%B8%B1%E0%B8%99%E0%B9%80%E0%B8%97%E0%B8%B4%E0%B8%87%E0%B9%80%E0%B8%81%E0%B8%B2%E0%B8%AB%E0%B8%A5%E0%B8%B5/page/{i}/' for i in range(1, 11)]
        n = len(pages_list)
    ...
    def data_in_link(self, session, url):
        ...
        with session.get(url) as response:
            ...
            self.content = ''
            section = bs.find('div', {'class' : 'entry-content-wrap'})
    ...
    def save_to_json(self):
        with open(f'./WebScrab/Seoulme.json', 'w', encoding="UTF-8") as file:
