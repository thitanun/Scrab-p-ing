...
class testKorseries:
    ...
    def data_domain_for_ref(self, session, url):
        with session.get(url) as response:
            ...
            self.webdata['website']['www.korseries.com'] = list_link


    def scrap_for_ref(self):
        pages_list = [f'https://www.korseries.com/koridol/page/{i}' for i in range(1, 6)]
        n = len(pages_list)
    ...
    def save_to_json(self):
        with open(f'./WebScrab/Korseries.json', 'w', encoding="UTF-8") as file:
