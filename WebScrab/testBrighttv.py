...
class testBrighttv:
    ...
    def data_domain_for_ref(self, session, url):
        with session.get(url) as response:
            ...
            self.webdata['website']['www.brighttv.co.th'] = list_link


    def scrap_for_ref(self):
        pages_list = [f'https://www.brighttv.co.th/category/entertain/korea/page/{i}' for i in range(1, 11)]
        n = len(pages_list)
    ...
    def save_to_json(self):
        with open(f'./WebScrab/Brighttv.json', 'w', encoding="UTF-8") as file:
